const SERVER_URL =
  ...
  'https://crud-springboot-production-ccb9.up.railway.app'

export const API_BASE_URL = `${SERVER_URL}/api/crud/users`

export const ENDPOINTS = {
  createUser: `${API_BASE_URL}/create`,
  allUsers: `${API_BASE_URL}/all_users`,
  deleteUser: (id) => `${API_BASE_URL}/delete/${id}`,
  updateUser: (id) => `${API_BASE_URL}/update/${id}`,
}

export const SERVER_DISPLAY_URL = API_BASE_URL
...
//   allUsers: `https://crud-springboot-production-ccb9.up.railway.app/api/crud/users/all_users`,
//   deleteUser: (id) => `${API_BASE_URL}/delete/${id}`,
//   updateUser: (id) => `${API_BASE_URL}/update/${id}`,
// }
